...
class AIService:
    ...
    def generate_response(self, system_instruction, user_query, rag_enabled=True, free_mode=False):
        ...
        generic_responses = [
            ...
            f"سؤالك '{user_query}' مهم، لكنه عام قليلاً. إذا كنت تبحث عن نص قانوني، أنصحك بمراجعة التشريع المدرسي. إذا كانت مشكلة ميدانية، فالمرونة هي الحل.",
            f"لست متأكداً من التفاصيل الدقيقة بدون سياق إضافي. أنا مبرمج للإجابة عن القضايا المدرسية (التلاميذ، الموظفين، الأولياء، البيداغوجيا).",
