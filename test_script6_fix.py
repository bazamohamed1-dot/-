...
def run_tests():
    ...
    Student.objects.create(student_id_number="1", last_name="A", first_name="A", gender="M", date_of_birth=date(2000,1,1), place_of_birth="X", academic_year="4 متوسط", class_name="1", enrollment_date=date.today())
    Student.objects.create(student_id_number="2", last_name="B", first_name="B", gender="M", date_of_birth=date(2000,1,1), place_of_birth="X", academic_year="4 متوسط", class_name="2", enrollment_date=date.today())
    Student.objects.create(student_id_number="3", last_name="C", first_name="C", gender="M", date_of_birth=date(2000,1,1), place_of_birth="X", academic_year="3 متوسط", class_name="1", enrollment_date=date.today())
